...
## 4) Generate mapping ↔ assertion links
...
## 5) Generate patch proposal (safe)
...
3. Generate suggestions and review diff preview.
4. Apply patch with conservative confidence threshold.
5. Run validation and push PR.
